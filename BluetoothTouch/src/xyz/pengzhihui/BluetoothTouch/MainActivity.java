...
public class MainActivity extends AppCompatActivity
{
    ...
    // 姿态数据
    public final static String poseData = "PD";
    // 传感器原始数据
    public final static String gyroData = "GD";
    public final static String magnetData = "MD";
    public final static String accelData = "AD";
